...
class TestJungleChessModel(unittest.TestCase):
    ...
    def test_piece_equality_and_rank_order(self):
        ...
        self.assertTrue(Rank.LION.value > Rank.RAT.value)
    ...
    def test_invalid_board_coordinates(self):
        ...
        with self.assertRaises(IndexError):
            self.board.cell_at(Position(10, 10))
    ...
    def test_rat_can_enter_river(self):
        ...
        self.assertTrue(self.rules._can_enter_cell(rat, "~", None))
    ...
    def test_elephant_cannot_enter_river(self):
        ...
        self.assertFalse(self.rules._can_enter_cell(elephant, "~", None))
    ...
    def test_lion_can_jump_river(self):
        ...
        self.assertTrue(self.rules._is_river_jump(lion.position, destination, self.board))
    ...
    def test_invalid_move_raises_error(self):
        ...
        valid, msg = self.game.move_piece(Position(0,0), Position(8,8))
    ...
    def test_save_and_load_game(self):
        """Saving and loading a game should return a valid Game instance."""
        ...
        # load_game은 실패하면 None을 반환하므로 성공 시 Game 인스턴스여야 함
    ...
    def test_load_nonexistent_file_returns_none(self):
        """Loading a non-existent save should return None (not raise)."""
        loaded_game = SaveGame.load_game("nonexistent.jungle")
        self.assertIsNone(loaded_game)


    def test_save_overwrites_file_safely(self):
        """Saving twice should overwrite without causing corruption."""
        ...
        self.assertIsInstance(loaded, Game)
    ...
    def test_load_nonexistent_file_raises(self):
        ...
        result = SaveGame.load_game("nonexistent.jungle")
